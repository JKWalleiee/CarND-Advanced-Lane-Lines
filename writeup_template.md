...
Next, I will describe in a general way each of the previous steps. The designed pipeline and the tests performed on it can be found on the Jupyter notebook [My_P2](https://github.com/udacity/CarND-Advanced-Lane-Lines/blob/master/writeup_template.md). From now on, whenever the notebook is referenced, the following notation will be use: in [No].
...
<img src="./info_images_output/solidWhiteCurve.jpg_gray.jpg" width="300">
...
The result of this pipeline can be found in [Output video](https://www.intmath.com/applications-differentiation/8-radius-curvature.php)